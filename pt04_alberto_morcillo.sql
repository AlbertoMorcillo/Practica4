...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2023 a las 01:19:36
...
--
-- Base de datos: `pt04_alberto_morcillo`
--
CREATE DATABASE IF NOT EXISTS `pt04_alberto_morcillo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pt04_alberto_morcillo`;
...
INSERT INTO `articles` (`article_id`, `article`, `usuari_id`) VALUES
...
INSERT INTO `usuaris` (`usuari_id`, `email`, `contrasena`) VALUES
